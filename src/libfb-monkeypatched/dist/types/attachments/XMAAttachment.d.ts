...
export interface XMAAttachment extends Attachment {
    type: ('UnavailableXMA' | 'StoryXMA' | 'ExternalUrlXMA' | 'AdvertXMA' | 'EventReminderXMA' | 'LeaderboardUpdateXMA' | 'LiveLocationXMA' | 'LocationXMA' | 'GroupXMA' | 'LightweightActionXMA' | 'PageXMA' | 'ProductXMA' | 'MontageXMA' | 'InstagramXMA');
    message?: string;
    description?: string;
    url?: string;
    imageURL?: string;
