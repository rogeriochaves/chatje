...
var author$project$Threads$Update$init = A2(
	Fresheyeball$elm_return$Return$return,
	{sample: ''},
	elm$core$Platform$Cmd$none);
var author$project$Types$Model = F2(
	function (router, threads) {
		return {router: router, threads: threads};
	});
var author$project$Types$MsgForThreads = function (a) {
	return {$: 'MsgForThreads', a: a};
};
...
var author$project$Update$init = F3(
	function (_n0, url, key) {
		return A3(
			...
			author$project$Types$MsgForThreads,
			author$project$Threads$Update$init,
			A3(
				author$project$Update$andMapCmd,
...
var author$project$Threads$Update$updateThreads = F2(
	function (msg, model) {
		return A2(Fresheyeball$elm_return$Return$return, model, elm$core$Platform$Cmd$none);
	});
var author$project$Threads$Update$update = F2(
	function (msgFor, model) {
		if (msgFor.$ === 'MsgForThreads') {
			var msg = msgFor.a;
			return A2(author$project$Threads$Update$updateThreads, msg, model);
		} else {
			return A2(Fresheyeball$elm_return$Return$return, model, elm$core$Platform$Cmd$none);
		}
	});
var author$project$Update$update = F2(
	function (msg, model) {
		return A3(
			author$project$Update$andMapCmd,
			author$project$Types$MsgForThreads,
			A2(author$project$Threads$Update$update, msg, model.threads),
			A3(
				author$project$Update$andMapCmd,
				author$project$Types$MsgForRouter,
...
var author$project$Threads$View$view = function (model) {
	return mdgriffith$elm_ui$Element$text('Edit me at src/Threads/View.elm');
};
				...
				[
					...
					_List_fromArray(
						[
							...
							author$project$Types$MsgForThreads,
							author$project$Threads$View$view(model.threads))
						]))
				]));
	} else {
